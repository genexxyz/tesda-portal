...
class="bg-white border-b border-gray-100 relative z-40">
        ...
        <div class="relative">
            ...
            <div x-show="userDropdown"
                ...
                <a href="#" 
                   ...
                   role="menuitem"
                   @click="closeDropdown()">
                    <x-icon name="cog" style="far" class="mr-2 w-4 h-4"/>
                    Settings
                </a>
    ...
    <div x-show="open && isMobile" 
         ...
         @click="toggleSidebar()"
         class="fixed inset-0 bg-gray-900 bg-opacity-20 mobile-overlay z-20"
    ...
    <div class="fixed top-0 left-0 h-full bg-primary text-white z-30 transform transition-all duration-300 ease-in-out"
     ...
     @mouseleave="!isMobile && (isHovered = false)">
        ...
        <div class="p-4 border-b border-primary-700 flex justify-center items-center h-16">
            <img src="{{ asset('storage/assets/img/default_logo.png') }}"
                 alt="TESDA Logo"
