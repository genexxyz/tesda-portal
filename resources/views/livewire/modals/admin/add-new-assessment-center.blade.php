<div>
    <x-modals.modal-header 
        title="Add New Assessment Center"
        subtitle="Create a new assessment center" />
                    ...
                    <div class="flex">
                        ...
                        <div class="ml-3">
                            ...
                            <div class="mt-2 text-sm text-blue-700">
                                <p>{{ count($selectedAssessors) }} assessor{{ count($selectedAssessors) > 1 ? 's' : '' }} will be assigned to this center:</p>
                                <ul class="list-disc list-inside mt-1 space-y-1">
                                    @foreach($availableAssessors->whereIn('id', $selectedAssessors) as $assessor)
                                        <li>{{ $assessor->name }}</li>
                                    @endforeach
                                </ul>
                            </div>
